...
//*************************************************************
// Rule
//1.  use App\Http\Requests\RelationshipsValidation; //Add Controller
//2.  public function store( RelationshipsValidation $request ){ //example
//*************************************************************

class RelationshipsValidation extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
				...
				"followed_id" => "nullable|integer", //integer('followed_id')->nullable()
