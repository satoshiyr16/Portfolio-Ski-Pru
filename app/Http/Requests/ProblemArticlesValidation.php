...
//*************************************************************
// Rule
//1.  use App\Http\Requests\ProblemArticlesValidation; //Add Controller
//2.  public function store( ProblemArticlesValidation $request ){ //example
//*************************************************************

class ProblemArticlesValidation extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
				...
				"comapany_id" => "nullable|integer", //integer('comapany_id')->nullable()
