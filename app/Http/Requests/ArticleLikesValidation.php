...
//*************************************************************
// Rule
//1.  use App\Http\Requests\ArticleLikesValidation; //Add Controller
//2.  public function store( ArticleLikesValidation $request ){ //example
//*************************************************************

class ArticleLikesValidation extends FormRequest
{
    /**
