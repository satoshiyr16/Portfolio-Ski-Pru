...
//*************************************************************
// Rule
//1.  use App\Http\Requests\ArticleFavoritesValidation; //Add Controller
//2.  public function store( ArticleFavoritesValidation $request ){ //example
//*************************************************************

class ArticleFavoritesValidation extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
				...
				"problem_solve_article_id" => "nullable|integer", //integer('problem_solve_article_id')->nullable()
