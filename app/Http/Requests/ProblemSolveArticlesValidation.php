...
//*************************************************************
// Rule
//1.  use App\Http\Requests\ProblemSolveArticlesValidation; //Add Controller
//2.  public function store( ProblemSolveArticlesValidation $request ){ //example
//*************************************************************

class ProblemSolveArticlesValidation extends FormRequest
{
    /**
